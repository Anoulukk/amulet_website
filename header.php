...
<body>
    <div class="container-fluid" style="padding-right: 0px; padding-left: 0px; position: relative;">
        ...
        <div class="register-btn">
            <button type="button" class="btn btn-warning " style=""><span><img src="img/edit_FILL0_wght400_GRAD0_opsz24.png" alt=""></span>&nbsp;ລົງທະບຽນ</button>
            <button type="button" class="btn btn-light " style=""><span><img src="img/" alt=""></span>&nbsp;ເຂົ້າສູ່ລະບົບ</button>
        </div>
